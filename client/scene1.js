class scene1 extends Phaser.Scene {
  ...
  create() {
    ...
    const fundo0Fase1 = map.createLayer('Fundo 0 - Fase 1', tilesets, 0, 0);
    const fundo1Fase1 = map.createLayer('Fundo 1 - Fase 1', tilesets, 0, 0);
    const fundo2Fase1 = map.createLayer('Fundo 2 - Fase 1', tilesets, 0, 0);
    ...
    this.player = this.physics.add.sprite(160, 360, "vd", 0);
