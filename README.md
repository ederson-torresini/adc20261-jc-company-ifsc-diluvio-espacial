...
## Premissa
Dois seres de outro planeta receberam uma missão divina de construir uma espaçonave, antes que o mundo deles seja destruído, sem se esquecer de levar junto com eles algumas das outras formas de vida do planeta. Porém, será que eles terão tempo suficiente para isso?
...
Custos principais: arte, desenvolvimento, programação marketing digital, trilha sonora e efeitos sonoros.

#### Influências (Breve)
● A História de Noé
História bíblica
Mesmo enredo, adaptado ao contexto de espaço e seres de outro planeta.

● Sprint Fox
Jogo (da Feria de Jogos de edições anteriores)
Mesmo modelo de plataforma e de jogo

● Hunters of Ancient Beasts
Jogo (da Feria de Jogos de edições anteriores)
A mesma ideia de usar inimigos e a “morte” para fazer voltar ao início da fase.

● Super Mario Galaxy
Jogo: Influência na ideia de plataforma com gravidade diferenciada e temática espacial.
